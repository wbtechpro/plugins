$.wbtRotator.l10n =
  ...
  RU:
    ...
    masks:
      ...
      ethmoid:
        title: "Решетчатая кость"
        description: "Губчатая кость, отделяющая полость носа от головного мозга. Подразделяется на решетчатый лабиринт, горизонтальную и вертикальную пластинки. Формирует верхнюю и среднюю носовые раковины. Сочленяется с лобной, клиновидной, небными, носовыми и слезными костями, а также с сошником, верхней челюстью и нижними носовыми раковинами. Формирует внутренние боковые поверхности глазниц."
      frontal:
        title: "Лобная кость"
      ...
      mandible:
        ...
        description: "Единственная подвижная кость черепа, образующая нижнюю часть висцерального скелета головы. Имеет тело и две ветви. Верхний край тела образует альвеолярную дугу с зубными альвеолами для 16 зубов. Нижня челюсть соединяется с височными костями посредством мыщелковых отростков на ветвях челюсти."
      maxilla:
        title: "Верхняя челюсть"
        description: "Образована парными костями, имеющими тело и четыре отростка: лобный, альвеолярный, небный и скуловой. Альвеолярные отростки содержат углубления - зубные альвеолы, в которых располагаются зубы. В толще тел верхнечелюстных костей располагаются гайморовы пазухи, а носовая поверхность верхних челюстей участвует в образовании латеральной стенки полости носа."
      nasal:
        title: "Носовые кости"
        description: "Кости, участвующие в образовании спинки носа и переднего отверстия носовой полости. Верхним краем соединены с носовой частью лобной кости, а латеральными краями - с лобными отростками верхнечелюстных костей."
      occipital:
        title: "Затылочная кость"
        description: "Расположена в задней части церебрального отдела черепа. Имеет базилярную часть, две латеральные части и затылочную чешую, которые окружают большое затылочное отверстие."
      palatine:
        title: "Небные кости"
